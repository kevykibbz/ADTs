...
public class Main {
     ...
     */
    private static void buildDB(List<Track> tracks, ArrayList<String> csvData) {
        ...
        for (String s: csvData) {
		    ...
		    tracks.inOrderTraverseTree(tracks.root);

            //tracks.preorderTraverseTree(tracks.root);

            //tracks.postOrderTraverseTree(tracks.root);

            // Find the node with key 75

            //System.out.println("\nNode with the key 87");

            //System.out.println(tracks.find(87));
        }
    }
